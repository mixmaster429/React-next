          ...
          <div className="container">
            <div className="text-wrapper">
              ...
              <p className="description">
                You will spend a third of your life on a mattress.
                MattressVerdict is here to help you make a better choice when
                buying an online mattress. We provide detailed reviews of the
                best rated mattresses in 2021.
              </p>
            ...
            <Col lg={{ span: 14, offset: 2 }}>
              <div className="section-details">
                ...
                <p>
                  ...
                  you’re here, the chances are you’re either replacing an old
                  and worn-out mattress or buying your first. Either way, you’re
                  likely overwhelmed by the various brands available today. But
                  what you’ll find even more perplexing are the different
                  mattress technologies and the jargon used in the market. In
                  this ultimate mattress buying guide, we’ve highlighted some
                  critical tips to guide you when choosing the best mattress to
                  buy today. We understand that narrowing down to just one bed
                  from the sea of options in the market isn’t easy. For that
                  reason, we’ve also included links to some of the top rated
                  mattresses that may perfectly match your sleeping needs.
                </p>
                ...
                <p>
                  ...
                  trees. This material offers most of the benefits of memory
                  foam, including pressure relief and motion isolation. However,
                  it does not have the stuck-in-bed feeling that makes
                  traditional memory foam a little annoying.
                </p>
                ...
                <p>
                  ...
                  over the years, innerspring mattresses are still a popular
                  pick today due in part to their affordability.
                </p>
                <p className="title">Hybrid Mattress</p>
                <img src="imgs/image4.png" alt="" />
                <p>
                  Hybrid mattresses are a new style of beds that combine 2 or
                  more mattress technologies. A typical hybrid mattress has an
                  all-foam comfort section and a coil-based core. Most of these
                  mattresses employ memory foam for the comfort layer, although
                  latex is common too. For the support system, most of the cheap
                  models have traditional Bonnell springs. However, the best
                  hybrid mattresses for the money have individually encased
                  springs that move independently to lower motion isolation and
                  offer localized support just where you need it.
                </p>
                ...
                <p>
                  ...
                  cushioning. A pillow-top mattress is a 2-tier bed with a
                  support section that can be anything from coil to foam or
                  latex. The pillow-top section is sewn or glued onto the main
                  mattress and may comprise wool, latex, or memory foam, among
                  other materials.
                </p>
              </div>
            </Col>
